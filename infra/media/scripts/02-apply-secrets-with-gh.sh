...
DEFAULT_SECRETS_FILE="$SCRIPT_DIR/cdn-secrets.env"
if [[ -f "$SCRIPT_DIR/ci-secrets.env" ]]; then
  DEFAULT_SECRETS_FILE="$SCRIPT_DIR/ci-secrets.env"
elif [[ -f "$SCRIPT_DIR/github-secrets.env" ]]; then
  DEFAULT_SECRETS_FILE="$SCRIPT_DIR/github-secrets.env"
fi
